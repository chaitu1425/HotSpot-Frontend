        ...
        <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
                ...
                <div className='flex justify-center items-center p-4 sm:p-6'>
                    <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                        <div className='flex flex-col items-center text-center'>
                            ...
                            <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-lg hover:bg-orange-600 transition-colors duration-200' onClick={() => navigate('/create-shop')} >Get Started</button>
                        </div>
                    </div>
                </div>
            }
            {
                ...
                <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
                    <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'><FaUtensils className='text-[#ff4d2d] w-14 h-14 ' />Wecolem to {shopData?.name}</h1>
                            ...
                            <div className='flex justify-center items-center p-4 sm:p-6'>
                                <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                                    <div className='flex flex-col items-center text-center'>
                                        ...
                                        <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-lg hover:bg-orange-600 transition-colors duration-200' onClick={() => navigate('/add-food')} >Add Food</button>
                                    </div>
                                </div>
                            </div>
                    }
                    {shopData.items.length > 0 &&
                    <div className='flex flex-col items-center gap-4 w-full max-w-3xl mb-10'>
