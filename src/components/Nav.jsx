        ...
        <div className='w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible'>
            ...
            {showSearch && userData?.role == "user" && <div className='w-[90%] h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%] md:hidden '>
                ...
                <div className='w-[80%] flex items-center gap-[10px]' >
                    ...
                    <input type="text" className='px-[10px] text-gray-700 outline-0 w-full' placeholder='search delicious food...' onChange={(e)=>setQuery(e.target.value)} />
                </div>
            </div>}
            ...
            <div className='flex items-center gap-4'>
                ...
                {userData.role == "owner" ? <>
                    ...
                    <div className='hidden md:flex items-center gap-1 cursor-pointer relative px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium' onClick={()=>navigate('/my-orders')}>
                        <TbReceipt2 size={15} />
                        <span>My orders</span>
                        {/* <span className='absolute -right-2 -top-2 text-sm font-bold text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]'>0</span> */}
                    </div>
                    <div className='md:hidden flex items-center gap-1 cursor-pointer relative px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium 'onClick={()=>navigate('/my-orders')}>
                        <TbReceipt2 size={15} />
                        {/* <span className='absolute -right-2 -top-2 text-sm font-bold text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]'>0</span> */}
                    </div>
                </> : (
                ...
                {showInfo && <div className={`fixed top-[80px] right-[10px] ${userData.role=='deliveryboy'?"md:right-[20%] lg:right-[35%]":"md:right-[10%] lg:right-[25%]"} md:right-[10%] lg:right-[20%] w-[180px] bg-white shadow-2xl rounded-xl p-[20px] flex flex-col gap-[10px] z-[9999]`}>
