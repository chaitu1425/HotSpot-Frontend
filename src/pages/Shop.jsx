...
function Shop() {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
        <button className='absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full shadow transition' onClick={()=>navigate('/')} ><FaArrowLeft /><span>Back</span></button>
        {shop && <div className='relative w-full h-64 md:h-80 lg:h-97'>
                ...
                <FaShop className='text-white text-4xl mb-3 drop-shadow-md' />
                ...
                <div className='flex items-center gap-[5px]'>
                    ...
                    <p className='text-lg  font-medium text-gray-300 mt-[10px] '>{shop.address}</p>
                </div>
                </div>
            </div>
        }
